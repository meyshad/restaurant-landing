...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    window.addEventListener('click', mobileNav); // Menu Section Tabs
    ...
    var popularSlider = document.querySelector('.js-popular');
    var sliderCarousel = new window.Flickity(popularSlider, {
      prevNextButtons: false,
      wrapAround: true,
      pageDots: false,
      adaptiveHeight: true
    });
    var flickityNext = document.querySelector('.js-popular_next');
    var flickityPrev = document.querySelector('.js-popular_prev');
    var flickityDots = document.querySelector('.js-popular_dots');
    ...
    function slideDots() {
      var foodDots = sliderCarousel.selectedIndex + 1;
      flickityDots.innerHTML = "<span class=\"c-popular-dishes__number-secondary\"> ".concat(foodDots, " </span> / ").concat(sliderCarousel.slides.length);
    }

    slideDots();
    sliderCarousel.on("select", slideDots); // gravity form setting
